...
public class HiBoard implements Serializable
{
	...
	private long hiBbsSeq;			//게시물번호
	private String userId;			//사용자 아이디
	private long hiBbsGroup;		//게시물 그룹번호
	private int	hiBbsOrder;			//게시물 그룹내순서
	...
	private String userName;		//사용자 이름(글쓰기 들어가있을때 기본적으로 보여주는거)
	...
	public HiBoard()
	{
		...
		hiBoardFile = null;	//hiboard의 시작 주소값만 가지고있는거
	}
